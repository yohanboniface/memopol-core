...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recommendation._for_count'
        db.add_column('votes_recommendation', '_for_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Recommendation._against_count'
        db.add_column('votes_recommendation', '_against_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Recommendation._abstention_count'
        db.add_column('votes_recommendation', '_abstention_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Recommendation._absent_count'
        db.add_column('votes_recommendation', '_absent_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Recommendation._for_count'
        db.delete_column('votes_recommendation', '_for_count')

        # Deleting field 'Recommendation._against_count'
        db.delete_column('votes_recommendation', '_against_count')

        # Deleting field 'Recommendation._abstention_count'
        db.delete_column('votes_recommendation', '_abstention_count')

        # Deleting field 'Recommendation._absent_count'
        db.delete_column('votes_recommendation', '_absent_count')
