...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LocalParty'
        db.create_table('meps_localparty', (
            ('party_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['reps.Party'], unique=True, primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meps.Country'], null=True)),
        ))
        db.send_create_signal('meps', ['LocalParty'])


    def backwards(self, orm):
        
        # Deleting model 'LocalParty'
        db.delete_table('meps_localparty')
