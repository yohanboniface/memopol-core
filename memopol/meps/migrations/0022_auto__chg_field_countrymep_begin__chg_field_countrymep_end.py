...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CountryMEP.begin'
        db.alter_column('meps_countrymep', 'begin', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CountryMEP.end'
        db.alter_column('meps_countrymep', 'end', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'CountryMEP.begin'
        db.alter_column('meps_countrymep', 'begin', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 16)))

        # Changing field 'CountryMEP.end'
        db.alter_column('meps_countrymep', 'end', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 16)))
