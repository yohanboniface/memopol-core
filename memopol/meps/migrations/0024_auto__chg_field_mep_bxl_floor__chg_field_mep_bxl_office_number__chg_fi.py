...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MEP.bxl_floor'
        db.alter_column('meps_mep', 'bxl_floor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.bxl_office_number'
        db.alter_column('meps_mep', 'bxl_office_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.bxl_phone2'
        db.alter_column('meps_mep', 'bxl_phone2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.bxl_phone1'
        db.alter_column('meps_mep', 'bxl_phone1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.bxl_fax'
        db.alter_column('meps_mep', 'bxl_fax', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.bxl_building'
        db.alter_column('meps_mep', 'bxl_building_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['meps.Building']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MEP.bxl_floor'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_floor' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.bxl_office_number'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_office_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.bxl_phone2'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_phone2' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.bxl_phone1'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_phone1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.bxl_fax'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_fax' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.bxl_building'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_building' and its values cannot be restored.")
