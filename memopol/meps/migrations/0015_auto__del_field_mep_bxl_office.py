...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MEP.bxl_office'
        db.delete_column('meps_mep', 'bxl_office')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MEP.bxl_office'
        raise RuntimeError("Cannot reverse this migration. 'MEP.bxl_office' and its values cannot be restored.")
