...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrganizationMEP'
        db.create_table('meps_organizationmep', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mep', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meps.MEP'])),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meps.Organization'])),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('begin', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('meps', ['OrganizationMEP'])


    def backwards(self, orm):
        
        # Deleting model 'OrganizationMEP'
        db.delete_table('meps_organizationmep')
