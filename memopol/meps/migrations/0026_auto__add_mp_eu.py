...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MP_EU'
        db.create_table('meps_mp_eu', (
            ('representative_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['representatives.Representative'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('meps', ['MP_EU'])


    def backwards(self, orm):

        # Deleting model 'MP_EU'
        db.delete_table('meps_mp_eu')
