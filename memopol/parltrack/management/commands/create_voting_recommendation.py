...
from memopol.meps.utils import update_total_score_of_all_meps, update_meps_positions
from memopol.meps.models import MEP
from memopol.votes.utils import clean_all_trends
from memopol.votes.models import RecommendationData, Proposal, Recommendation, Vote, Score
from memopol.base.utils import update_search_index
    ...
    for key, choice in choices:
        for group in data[key]["groups"]:
            for mep in group["votes"]:
                representative = find_matching_mep_in_db(mep)
