...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Opinion._author'
        db.add_column('reps_opinion', '_author', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['reps.Representative'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Opinion._author'
        db.delete_column('reps_opinion', '_author_id')
