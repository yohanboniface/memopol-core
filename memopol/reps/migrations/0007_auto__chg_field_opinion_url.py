...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opinion.url'
        db.alter_column('reps_opinion', 'url', self.gf('django.db.models.fields.URLField')(max_length=400))


    def backwards(self, orm):
        
        # Changing field 'Opinion.url'
        db.alter_column('reps_opinion', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
