...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Opinion._date'
        db.add_column('reps_opinion', '_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Opinion._date'
        db.delete_column('reps_opinion', '_date')
