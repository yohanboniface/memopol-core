...
from memopol.base import utils

from memopol.mps.models import MP, Group, Department
from memopol.mps.views import MPList, MPsFromModel, MPView
from memopol.reps.models import Opinion


urlpatterns = patterns('memopol.mps.views',
    ...
    url(r'^vote/', include("memopol.mps_votes.urls", namespace="votes", app_name="mps_urls")),
