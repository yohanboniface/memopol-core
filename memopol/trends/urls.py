...
urlpatterns = patterns('memopol.trends.views',
    ...
    url(r'^proposal/(?P<proposal_id>\w+)-countries-map.(?P<extension>\w+)$', 'proposal_countries_map', name='recommendation_countries_map'),
