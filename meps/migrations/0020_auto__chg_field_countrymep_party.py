...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CountryMEP.party'
        db.alter_column('meps_countrymep', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meps.LocalParty']))


    def backwards(self, orm):
        
        # Changing field 'CountryMEP.party'
        db.alter_column('meps_countrymep', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reps.Party']))
