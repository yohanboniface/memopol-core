...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MEP.stg_floor'
        db.add_column('meps_mep', 'stg_floor', self.gf('django.db.models.fields.CharField')(default='-1', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MEP.stg_floor'
        db.delete_column('meps_mep', 'stg_floor')

        # Deleting field 'MEP.stg_office_number'
        db.delete_column('meps_mep', 'stg_office_number')
