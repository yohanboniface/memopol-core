...
from reps.models import CV, Email, Opinion, OpinionREP
from meps.models import Deleguation, Committee, Country, Group, MEP, Party, WebSite, DeleguationRole, CommitteeRole
