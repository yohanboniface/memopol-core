...
from reps.models import Party, CV, Email, Opinion, OpinionREP
from meps.models import Deleguation, Committee, Country, Group, MEP, WebSite, DeleguationRole, CommitteeRole
