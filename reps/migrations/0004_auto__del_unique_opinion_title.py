...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Opinion', fields ['title']
        db.delete_unique('reps_opinion', ['title'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Opinion', fields ['title']
        db.create_unique('reps_opinion', ['title'])
