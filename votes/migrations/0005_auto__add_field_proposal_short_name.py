...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.short_name'
        db.add_column('votes_proposal', 'short_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=25, null=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Proposal.short_name'
        db.delete_column('votes_proposal', 'short_name')
