...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.ponderation'
        db.add_column('votes_proposal', 'ponderation', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Proposal.ponderation'
        db.delete_column('votes_proposal', 'ponderation')
