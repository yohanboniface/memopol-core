...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('votes_proposal', 'institution', self.gf('django.db.models.fields.CharField')(default='EU', max_length=63), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Proposal.institution'
        db.delete_column('votes_proposal', 'institution')
