...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganizationMEP.begin'
        db.alter_column('meps_organizationmep', 'begin', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'OrganizationMEP.end'
        db.alter_column('meps_organizationmep', 'end', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'OrganizationMEP.begin'
        db.alter_column('meps_organizationmep', 'begin', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 16)))

        # Changing field 'OrganizationMEP.end'
        db.alter_column('meps_organizationmep', 'end', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 16)))
