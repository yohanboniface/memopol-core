...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MEP.stg_phone1'
        db.alter_column('meps_mep', 'stg_phone1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.stg_building'
        db.alter_column('meps_mep', 'stg_building_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['meps.Building']))

        # Changing field 'MEP.stg_phone2'
        db.alter_column('meps_mep', 'stg_phone2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.stg_floor'
        db.alter_column('meps_mep', 'stg_floor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.stg_office_number'
        db.alter_column('meps_mep', 'stg_office_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'MEP.stg_fax'
        db.alter_column('meps_mep', 'stg_fax', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MEP.stg_phone1'
        raise RuntimeError("Cannot reverse this migration. 'MEP.stg_phone1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.stg_building'
        raise RuntimeError("Cannot reverse this migration. 'MEP.stg_building' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.stg_phone2'
        raise RuntimeError("Cannot reverse this migration. 'MEP.stg_phone2' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.stg_floor'
        raise RuntimeError("Cannot reverse this migration. 'MEP.stg_floor' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.stg_office_number'
        raise RuntimeError("Cannot reverse this migration. 'MEP.stg_office_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MEP.stg_fax'
        raise RuntimeError("Cannot reverse this migration. 'MEP.stg_fax' and its values cannot be restored.")
