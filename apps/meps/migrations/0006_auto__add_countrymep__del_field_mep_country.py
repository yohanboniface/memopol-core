...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CountryMEP'
        db.create_table('meps_countrymep', (
        ...
        db.send_create_signal('meps', ['CountryMEP'])

        # Deleting field 'MEP.country'
        db.delete_column('meps_mep', 'country_id')


    def backwards(self, orm):
        
        # Deleting model 'CountryMEP'
        db.delete_table('meps_countrymep')

        # Adding field 'MEP.country'
        db.add_column('meps_mep', 'country', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['meps.Country']), keep_default=False)
