...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MEP.postal_addr'
        db.add_column('meps_mep', 'postal_addr', self.gf('django.db.models.fields.CharField')(default='not imported yet, plz notify us about this', max_length=255), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'MEP.postal_addr'
        db.delete_column('meps_mep', 'postal_addr')
    ...
    models = {
        ...
        'meps.mep': {
            ...
            'postal_addr': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
