...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('meps_postaladdress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('addr', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('mep', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meps.MEP'])),
        ))
        db.send_create_signal('meps', ['PostalAddress'])


    def backwards(self, orm):
        
        # Deleting model 'PostalAddress'
        db.delete_table('meps_postaladdress')
