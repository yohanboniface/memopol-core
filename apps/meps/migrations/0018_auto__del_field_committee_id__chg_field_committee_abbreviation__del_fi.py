...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Committee.id'
        db.delete_column('meps_committee', 'id')

        # Changing field 'Committee.abbreviation'
        db.alter_column('meps_committee', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=30, primary_key=True))

        # Deleting field 'Group.id'
        db.delete_column('meps_group', 'id')

        # Changing field 'Group.abbreviation'
        db.alter_column('meps_group', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True))

        # Deleting field 'Country.id'
        db.delete_column('meps_country', 'id')

        # Changing field 'Country.code'
        db.alter_column('meps_country', 'code', self.gf('django.db.models.fields.CharField')(max_length=2, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Committee.id'
        raise RuntimeError("Cannot reverse this migration. 'Committee.id' and its values cannot be restored.")

        # Changing field 'Committee.abbreviation'
        db.alter_column('meps_committee', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
        ...
        # Changing field 'Group.abbreviation'
        db.alter_column('meps_group', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
        ...
        # Changing field 'Country.code'
        db.alter_column('meps_country', 'code', self.gf('django.db.models.fields.CharField')(max_length=2, unique=True))
    ...
    models = {
        ...
        'meps.committee': {
            ...
            'abbreviation': ('django.db.models.fields.CharField', [], {'max_length': '30', 'primary_key': 'True'}),
        ...
        'meps.group': {
            ...
            'abbreviation': ('django.db.models.fields.CharField', [], {'max_length': '10', 'primary_key': 'True'}),
