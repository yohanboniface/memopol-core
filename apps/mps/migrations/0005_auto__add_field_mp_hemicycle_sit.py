...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MP.hemicycle_sit'
        db.add_column('mps_mp', 'hemicycle_sit', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MP.hemicycle_sit'
        db.delete_column('mps_mp', 'hemicycle_sit')
