...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Representative.birth_date'
        db.alter_column('reps_representative', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Representative.birth_date'
        db.alter_column('reps_representative', 'birth_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 16)))
