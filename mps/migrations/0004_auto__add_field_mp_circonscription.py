...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MP.circonscription'
        db.add_column('mps_mp', 'circonscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mps.Circonscription'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MP.circonscription'
        db.delete_column('mps_mp', 'circonscription_id')
